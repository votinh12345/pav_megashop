 ...
 */
namespace Hiennv\Category\Block\Html;
...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            $html .= '<li ' . $this->_getRenderedMenuItemAttributes($child) . '><div class="'.(($childLevel == self::LEVER_0) ? 'pc5-nav-r-1 pc5-nav-osusume' : 'pc5-nav-sm-2').'">';
    ...
    protected function _addSubMenu($child, $childLevel, $childrenWrapClass, $limit)
    {
        ...
        $html .= '<ul class="level' . $childLevel . ' submenu" style="display:none">';
