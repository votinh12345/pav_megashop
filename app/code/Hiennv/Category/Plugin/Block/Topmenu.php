 ...
 */
namespace Hiennv\Category\Plugin\Block;

use Magento\Framework\Data\Collection;
use Magento\Framework\Data\Tree\Node;
use Hiennv\Category\Model\Category;
...
class Topmenu
{
    ...
    private function getCategoryAsArray($category, $currentCategory)
    {
        return [
            ...
            'class_category' => $category->getcIonCategory(),
            'color_category' => $category->getBackgroundColor()
        ];
    }
    ...
    protected function getCategoryTree($storeId, $rootId)
    {
        ...
        $collection->addAttributeToSelect('class_category');
